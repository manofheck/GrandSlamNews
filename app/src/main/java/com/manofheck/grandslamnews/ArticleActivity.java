...
public class ArticleActivity extends AppCompatActivity
    ...
    /** URL for article data from theGuardian API */
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        if (key.equals(getString(R.string.settings_grand_slam_key))) {
            ...
            // Restart the loader to requery the Guardian API as the query settings have been updated
    ...
    public Loader<List<Article>> onCreateLoader(int i, Bundle bundle) {
        ...
        String grandSlam = sharedPrefs.getString(
                getString(R.string.settings_grand_slam_key),
                "@string/settings_grand_slam_value");
        Log.e("Grand Slam", grandSlam);

        Uri baseUri = Uri.parse(GUARDIAN_REQUEST_URL);
        Uri.Builder uriBuilder = baseUri.buildUpon();

        uriBuilder.appendQueryParameter("show-tags", "contributor");
        uriBuilder.appendQueryParameter("q",grandSlam);
