...
/**
 * Helper methods related to requesting and receiving article data from theGUARDIAN API.
 */
    ...
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                // Create a new {@link Article} object with the publicationDate, title,
                // and url from the JSON response.
                Article article = new Article(publicationDate, title, contributor, url);
